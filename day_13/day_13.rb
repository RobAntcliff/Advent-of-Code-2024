def part_1
  ...
  coordinate_blocks = input.map do |block|
    ...
    x1 = lines[0].split("X+")[1].split(",")[0].to_i  # => 94
    y1 = lines[0].split("Y+")[1].to_i  # => 34

    x2 = lines[1].split("X+")[1].split(",")[0].to_i  # => 22
    y2 = lines[1].split("Y+")[1].to_i  # => 67

    prize_x = lines[2].split("X=")[1].split(",")[0].to_i  # => 8400
    prize_y = lines[2].split("Y=")[1].to_i  # => 5400
